...
static int get_options(int *argc_ptr, char ***argv_ptr)
{
  ...
  */
  ...
  const char* blacklist = "auto_increment_increment,auto_increment_offset,connect_timeout,expire_logs_days,interactive_timeout,key_cache_age_threshold,max_allowed_packet,slave_max_allowed_packet,old_passwords,secure_auth,rpl_recovery_rank,div_precision_increment,server_id,innodb_fast_shutdown,innodb_force_recovery";
